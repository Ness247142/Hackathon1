...
heb.addEventListener("click",function(event){
    ...
    homeImg3.textContent="לב ווה";
    homeText3.textContent="קלדוניה החדשה";
    homeImg4.textContent="חופש";
    homeText4.textContent="מסעדה צרפתית";
    homeImg5.textContent="בורה בורה";
    homeText5.textContent="פולינזיה הצרפתית; המקום הכי יפה לחלום עליו";
...
fr.addEventListener("click",function(event){
    ...
    homeImg3.textContent="Coeur de Voh";
    homeText3.textContent="Nouvelle Calédonie";
    homeImg4.textContent="Liberté";
    homeText4.textContent="Restaurant français";
    homeImg5.textContent="Bora Bora";
    homeText5.textContent="Polynésie française; le plus bel endroit pour s'évader";
